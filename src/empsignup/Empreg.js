  ...
  return (
    <div>
      ...
      <div className=' inline absolute  top-[10%] left-[10%]'>
        ...
        <input type="text" name='firstname' className='w-[461px] h-[50px] bg-[#D9D9D9]' />
        </div>

        <div className='inline absolute top-[10%] left-[70%]'>
        <label htmlFor="name" className='font-[400] text-[20px] ml-[0px] mb-[10px]'>Logo</label><br/>
        <input type="file" id='file1' name='firstname' className='w-[210px] h-[50px] bg-[#D9D9D9]' />
        </div>
        ...
        <input type="text" name='firstname' className='w-[695px] h-[50px] bg-[#D9D9D9]' />
        </div>
        
        <div className=' inline absolute  top-[65%] left-[10%]'>
        <label htmlFor="name" className='font-[400] text-[20px] ml-[0px] mb-[10px]'> City</label><br/>
        <input type="text" name='firstname' className='w-[227px] h-[50px] bg-[#D9D9D9]' />
        </div>
      ...
      {/* about the company */}
      <div className="con3">
      <textarea name="about" id="" cols="50" rows="4" className='  absolute w-[722px] h-[200px] top-[10%] left-[5%]  bg-[#D9D9D9]' placeholder='A short description about the organization' ></textarea>
      </div>

      <div className="btn">
      <button className='absolute top-[1500px] left-[709px] rounded-[35px] bg-[#D9D9D9] w-[116px] h-[40px] '>Submit</button>
      </div>
    </div>
  )
}
